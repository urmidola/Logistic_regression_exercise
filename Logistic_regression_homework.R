...
head(newdata2, 100)
##This tells us that probability of working for a) Married-spouse in household
## is 88.5%, b) Married-spouse not in household is 87.7% , c) Widowed is 87.9%, 
## d) Divorced is 94.7% , ## e) Separated is 88.2%, f) Never married is 75.3%, 
##g) Living with partner is 88.3%
